...
DROP FUNCTION IF EXISTS normDiv_solSubResultavgs(div_num integer, subject text);

CREATE FUNCTION normDiv_solSubResultavgs(div_num integer, subject text)
...
ALTER FUNCTION normDiv_solSubResultavgs(div_num integer, subject text) OWNER TO nectar;
