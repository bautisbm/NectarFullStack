...
DROP FUNCTION IF EXISTS highSchScores_per_StemDiv(div_num integer, subject text);

CREATE FUNCTION highSchScores_per_StemDiv(div_num integer, subject text)
...
ALTER FUNCTION highSchScores_per_StemDiv(div_num integer, subject text) OWNER TO nectar;